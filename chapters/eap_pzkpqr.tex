\section{PBA Using ZKP-QRP Implemented as an EAP Method} %TODO: Reword every Sub-Type to Subtype
...
If $b=0$, then $z = u$, where $u$ was generated for the subtype 1 response. %TODO: Remove conditions
